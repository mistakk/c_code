...
//A and B will become empty at the same time.For the fourth operation, 
//B will become empty first.So the total probability of A becoming empty first plus half the probability that A and B become empty at the same time, 
